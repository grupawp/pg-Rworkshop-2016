---
title: "Przegląd metod klasyfikacji binarnej"
---
...
- Organizatorzy: [Paweł Cejrowski](https://github.com/pcejrowski), [Naukowe Koło Matematyki](http://www.mif.pg.gda.pl/nkm/?page_id=57)
- Prowadzący: [Marcin Kosiński](https://github.com/MarcinKosinski)
...
```{r, child="01_omowienie_danych.Rmd"}

```


```{r, child="02_selekcja_zmiennych.Rmd"}

```


```{r, child="03_o_klasyfikacji.Rmd"}

```


```{r, child="05_element.Rmd"}
